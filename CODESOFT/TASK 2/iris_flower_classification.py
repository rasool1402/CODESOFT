...
Original file is located at
    https://colab.research.google.com/drive/1Gtp-QroH8nW8Byoc0muCdsa_nW8kSlPZ
"""
...
# Select only the numeric columns from the Iris dataset
...
sns.heatmap(correlation_matrix, annot=True, cmap='cubehelix', linewidths=1, linecolor='k', square=True, mask=False, vmin=-1, vmax=1, cbar_kws={"orientation": "vertical"}, cbar=True)
plt.show()
